    ...
    <form action="/" method="post" class="regi-u" enctype="multipart/form-data">
        ...
        <div class="regi-u_body">
            ...
            <div class="regi-u_body_image">
                ...
                <img class="regi-u_body_image_picture" id="0" src="{{asset('storage/'.$user->user_image)}}"></img>
            ...
            <div class="regi-u_body_user">
                ...
                <input type="text" name="name" class="regi-u_body_user_input" value="{{$user->name}}">
            </div>
            <div class="regi-u_body_postcode">
                <div class="regi-u_body_postcode_title">郵便番号</div>
                <input type="text" name="postcode" class="regi-u_body_postcode_input" value="{{$user->postcode}}">
            </div>
            <div class="regi-u_body_address">
                <div class="regi-u_body_address_title">住所</div>
                <input type="text" name="address" class="regi-u_body_address_input" value="{{$user->address}}">
            </div>
            <div class="regi-u_body_building">
                <div class="regi-u_body_building_title">建物</div>
                <input type="text" name="building" class="regi-u_body_building_input" value="{{$user->building}}">
            </div>
